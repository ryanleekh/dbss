...
def telegram():
    ...
    domain_url = 'https://dbss-oofx.onrender.com'
    ...
    if webhook_response.status_code == 200:
        # set status message
        status = "The telegram bot is running. Please check with the telegram bot. @playhards_bot"
    else:
...
def deepseek_reply():
    ...
    return(render_template("deepseek_reply2.html",r=completion.choices[0].message.content, r2=completion2.choices[0].message.content));
